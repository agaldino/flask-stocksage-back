...
dataset_path = "C:\Users\alexa\OneDrive\Anexos\Fiap\stocksage_fiap_challenge\flask-stocksage-back\dairy\current_processed_data.csv"
df = pd.read_csv(dataset_path)


@app.route("/", methods=["GET"])
def home():
    return jsonify({"message": "Welcome to the Dairy Prediction API!"})
